/* ResetPassword components available on the web are of poor quality,
 * I put minimal effort to make one at least decent, but there still could be much incompleteness,
